    ...
    <div
      ...
      <div className="max-w-[1230px] mx-auto pt-[210px] max-[770px]:pt-[100px] px-[20px]">
        <div className="text-center mb-[60px]">
          <h1 className="mb-[24px] font-[700] text-[46px] max-[640px]:text-[36px]">Our services</h1>
          <p className="text-[18px] text-[#787A80] font-[400] mx-auto noBold">
        ...
        <section
          ...
          <div
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className="group-hover:scale-110 transition-transform">
              <g clip-path="url(#clip0_144815_1789)">
                <path
          ...
          <div
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              className="group-hover:scale-110 transition-transform">
              <g clip-path="url(#clip0_144815_1698)">
                <path
        ...
        <div className="flex flex-col md:flex-row gap-[40px] items-center justify-center pb-[60px] text-center">
