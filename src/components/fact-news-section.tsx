      ...
      <Container className="pt-[170px] max-[550px]:pt-[90px]">
        <div className="text-center">
          <motion.h1
            ...
            viewport={{ once: true }}
            className="font-[700] text-[46px] mb-[60px] max-[600px]:text-[32px] px-[40px]">
          ...
          <div className="flex gap-[48px] items-center justify-center mb-[180px] max-[900px]:grid max-[900px]:grid-cols-2 justify-items-center max-[550px]:grid-cols-1">
            <motion.div
              initial={{ opacity: 0, x: isSmallScreen ? 100 : -300 }}
              whileInView={{ opacity: 1, x: 0, transition: { delay: isSmallScreen ? 0.2 : 0 } }}
              viewport={{ once: true }}
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
          className="mb-[60px] font-[700] text-center text-[46px]">
          Recent news
        </motion.h1>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0, transition: { delay: 0.4 } }}
          viewport={{ once: true }}
          className="flex justify-center gap-[40px] items-center mb-[60px] mt-[85px] px-[20px] max-[655px]:flex-col">
